...
card <- c('Blue-Eyes white Dragon', 'Exodius' , 'The Winged Dragon of Ra' , 'Raigeki' , 'Slifer the Sky Dragon','Obelisk the Tormentor' , 'Black Luster Soldier' , '5-Headed Dragon' , 'Exodia The Forbidden One' , 'Dragon Master Knight')
